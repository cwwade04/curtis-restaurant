...
function Contact() {
  ...
  return (
    <div className="page">
      ...
      <div className="contact-header">
        <h1>Contact one of the crew!</h1>
        <p>Send us a message about questions or visits.</p>
      </div>
  ...
  <p>
    Whether it’s a quick question, catering request, or planning your next visit,
    we’re always happy to hear from you.
  </p>

  <p>
    At Smoke and Salsa, every message matters. We take pride in serving real food
    with real care, and that starts with staying connected to our community.
  </p>

  <p className="contact-highlight">
    We’ll get back to you as soon as we can and we hope to see you soon!
  </p>
</div>
    </div>
  );
